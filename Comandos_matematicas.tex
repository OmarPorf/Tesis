...
\newcommand{\DOMINIO}[1]{\operatorname{dom}\pa*{#1}}
\newcommand{\RANGO}[1]{\operatorname{ran}\pa*{#1}}
...
\newcommand{\VARIABLESDE}[1]{\mathrm{Var}\bra*{#1}}
\newcommand{\LIBRESDE}[1]{\mathrm{Free}\bra*{#1}}
